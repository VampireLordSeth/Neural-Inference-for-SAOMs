...
10. M3b (co-evolution) done 2026-09-13 (`docs/M3_RESULTS.md`, second part):
    ...
    1.5–1.7 sd off at both budgets. RSiena ML fit (2026-09-18, 6.4 h,
    `rsiena_coevolution_maxlike.R`): avAlt 0.33 ± 0.26, quad −0.29 ± 0.11 —
    the far side of MoM from us; PPC (`ppc_coev.py`): none of the three points
    is outside the 95% predictive on any behaviour statistic — s50 cannot
    resolve the pair. Suspect our side (start homophily, see M4).
